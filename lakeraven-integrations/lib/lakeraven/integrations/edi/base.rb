...
module Lakeraven
  module Integrations
    module Edi
      ...
      #
      # Private commercial implementations (e.g. commercial clearinghouses) live in
      # the private lakeraven-private monorepo as per-vendor gems like
      # other clearinghouse adapters, lakeraven-fredi, etc. Each implements this interface.
      #
