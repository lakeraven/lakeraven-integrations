    ...
    module Supplemental
      class AttributesTest < Minitest::Test
        ...
        def test_value_system_uri
          assert_equal "https://terminology.lakeraven.com/CodeSystem/uds-supplemental-value", Attributes::VALUE_SYSTEM
        end
      ...
      class PayerCategoryTest < Minitest::Test
        def test_code_system_uri
          assert_equal "https://terminology.lakeraven.com/CodeSystem/uds-payer-category", PayerCategory::CODE_SYSTEM
        end
